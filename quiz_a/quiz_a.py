...
def judge(multitask, creativity, forgetAction, forgetItem,
    ...
    if int(careless) >= 2:
        ...
        return "様々なことに対して苦手はあまりないようです。ただし、人より不安になりやすい部分があるかもしれません。\
            上手くいかないときには自身の不安や緊張が影響していることもあるでしょう。\n以下の苦手対策ページ一覧から【○○】を選択して対策を確認してみてください。"
    else:
        return "苦手な傾向は今回の結果からは見当たりませんでした。\
            他の診断をお試しいただくか、苦手対策ページの一覧から気になるものを試してみてください。"
